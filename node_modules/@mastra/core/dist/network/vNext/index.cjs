...
var NewAgentNetwork = class extends chunkP3Q73CAW_cjs.MastraBase {
  ...
  async getRoutingAgent({ runtimeContext }) {
    ...
    const instructions = `
        ...
        `;
    return new chunkD6KIRZP6_cjs.Agent({
      name: "routing-agent",
      instructions,
      model: this.#model,
      memory: memoryToUse,
  ...
  async loop(message, {
    ...
    const finalStep = chunkRIDAFDLW_cjs.createStep({
      id: "final-step",
    ...
    const mainWorkflow = chunkRIDAFDLW_cjs.createWorkflow({
  ...
  createWorkflow({ runtimeContext }) {
    ...
    const routingStep = chunkRIDAFDLW_cjs.createStep({
      id: "routing-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
...
${completionResult.object.finalResult}` : ""}
    ...
    const agentStep = chunkRIDAFDLW_cjs.createStep({
      id: "agent-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const workflowStep = chunkRIDAFDLW_cjs.createStep({
      id: "workflow-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const toolStep = chunkRIDAFDLW_cjs.createStep({
      id: "toolStep",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const finishStep = chunkRIDAFDLW_cjs.createStep({
      id: "finish-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const networkWorkflow = chunkRIDAFDLW_cjs.createWorkflow({
